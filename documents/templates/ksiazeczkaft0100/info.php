...
$engine = array(
	'name' => 'ksiazeczkaft0100', 	// template directory
	'engine' => 'ksiazeczkaft0100', 			// engine.php directory
						// you can use other engine
	'template' => 'template.html', 		// template file (in 'name' dir)
	'title' => 'Książeczka opłat FT0100', 	// description for UI
	'content_type' => 'text/html', 		// output file type
	'output' => 'ksiazeczkaoplat', 		// output file name
