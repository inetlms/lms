...
//Name              buttonID                 buttonTitle           buttonImage                            buttonImageRollover
	...
	"justifyleft":    ['Justifyleft',          'Wyrównaj do lewej',        imagesDir + 'justify_left.gif',       imagesDir + 'justify_left_on.gif'],
	"justifycenter":  ['Justifycenter',        'Centruj',      imagesDir + 'justify_center.gif',     imagesDir + 'justify_center_on.gif'],
	"justifyright":   ['Justifyright',         'Wyrównaj do prawej',       imagesDir + 'justify_right.gif',      imagesDir + 'justify_right_on.gif'],
	...
	"outdent":        ['Outdent',              'Cofnij wcięcie',            imagesDir + 'indent_left.gif',        imagesDir + 'indent_left_on.gif'],
	"indent":         ['Indent',               'Dodaj wcięcie',             imagesDir + 'indent_right.gif',       imagesDir + 'indent_right_on.gif'],
	"cut":            ['Cut',                  'Wytnij',                imagesDir + 'cut.gif',                imagesDir + 'cut_on.gif'],
	"copy":           ['Copy',                 'Kopiuj',               imagesDir + 'copy.gif',               imagesDir + 'copy_on.gif'],
	"paste":          ['Paste',                'Wklej',              imagesDir + 'paste.gif',              imagesDir + 'paste_on.gif'],
	"forecolor":      ['ForeColor',            'Kolor tekstu',          imagesDir + 'forecolor.gif',          imagesDir + 'forecolor_on.gif'],
	"backcolor":      ['BackColor',            'Kolor tła',          imagesDir + 'backcolor.gif',          imagesDir + 'backcolor_on.gif'],
	"undo":           ['Undo',                 'Confij',               imagesDir + 'undo.gif',               imagesDir + 'undo_on.gif'],
	"redo":           ['Redo',                 'Przywróć',               imagesDir + 'redo.gif',               imagesDir + 'redo_on.gif'],
	"inserttable":    ['InsertTable',          'Wstaw tabelę',        imagesDir + 'insert_table.gif',       imagesDir + 'insert_table_on.gif'],
	"insertimage":    ['InsertImage',          'Wstaw obraz',        imagesDir + 'insert_picture.gif',     imagesDir + 'insert_picture_on.gif'],
	"createlink":     ['CreateLink',           'Dodaj link',         imagesDir + 'insert_hyperlink.gif',   imagesDir + 'insert_hyperlink_on.gif'],
	"viewSource":     ['ViewSource',           'Pokaż źródło',         imagesDir + 'view_source.gif',        imagesDir + 'view_source_on.gif'],
	"viewText":       ['ViewText',             'Pokaż tekst',           imagesDir + 'view_text.gif',          imagesDir + 'view_text_on.gif'],
...
function generate_wysiwyg(textareaID) {
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px inset #CCCCCC;"><tr><td valign="top" class="wysiwyg_textarea">\n'
...
function viewSource(n) {
  ...
  document.getElementById('HTMLMode' + n).style.display = 'none'; 
	...
	getDocument.body.style.fontSize = "8pt";
