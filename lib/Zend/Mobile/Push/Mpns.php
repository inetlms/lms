...
require_once LIB_DIR.'/Zend/Mobile/Push/Abstract.php';

/** Zend_Mobile_Push_Message_Mpns **/
require_once LIB_DIR.'/Zend/Mobile/Push/Message/Mpns.php';
        ...
        switch ($response->getStatus())
        {
            case 200:
                ...
                if ($response->getHeader('NotificationStatus') == 'QueueFull') {
                    require_once LIB_DIR.'/Zend/Mobile/Push/Exception/DeviceQuotaExceeded.php';
                ...
                break;
            case 400:
                require_once LIB_DIR.'/Zend/Mobile/Push/Exception/InvalidPayload.php';
                throw new Zend_Mobile_Push_Exception_InvalidPayload('The message xml was invalid');
                break;
            case 401:
                require_once LIB_DIR.'/Zend/Mobile/Push/Exception/InvalidToken.php';
            ...
            case 405:
                ...
                break;
            case 406:
                require_once LIB_DIR.'/Zend/Mobile/Push/Exception/QuotaExceeded.php';
            ...
            case 412:
                ...
                break;
            case 503:
                require_once LIB_DIR.'/Zend/Mobile/Push/Exception/ServerUnavailable.php';
