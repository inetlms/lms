...
require_once LIB_DIR.'/Zend/Mobile/Push/Message/Gcm.php';

/** Zend_Mobile_Push_Response_Gcm **/
require_once LIB_DIR.'/Zend/Mobile/Push/Response/Gcm.php';
    ...
    public function send(Zend_Mobile_Push_Message_Abstract $message)
    {
        ...
        switch ($response->getStatus())
        {
            ...
            case 503:
                ...
                break;
            case 401:
                require_once LIB_DIR.'/Zend/Mobile/Push/Exception/InvalidAuthToken.php';
