 ...
 */
require_once LIB_DIR.'/Zend/Mail/Transport/Abstract.php';
 ...
 */
require_once LIB_DIR.'/Zend/Mime/Message.php';

/**
 * @see Zend_Mime_Part
 */
require_once LIB_DIR.'/Zend/Mime/Part.php';
...
class Zend_Mail extends Zend_Mime_Message
{
    ...
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed)) {
             ...
             */
            require_once LIB_DIR.'/Zend/Mail/Exception.php';
    ...
    public function send($transport = null)
    {
        if ($transport === null) {
            if (! self::$_defaultTransport instanceof Zend_Mail_Transport_Abstract) {
                require_once LIB_DIR.'/Zend/Mail/Transport/Sendmail.php';
