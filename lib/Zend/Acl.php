 ...
 */
require_once LIB_DIR.'/Zend/Acl/Role/Registry.php';


/**
 * @see Zend_Acl_Assert_Interface
 */
require_once LIB_DIR.'/Zend/Acl/Assert/Interface.php';


/**
 * @see Zend_Acl_Role
 */
require_once LIB_DIR.'/Zend/Acl/Role.php';
...
class Zend_Acl
{
    ...
    public function addRole($role, $parents = null)
    {
        ...
        if (!$role instanceof Zend_Acl_Role_Interface) {
            require_once LIB_DIR.'/Zend/Acl/Exception.php';
