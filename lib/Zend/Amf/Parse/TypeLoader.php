 ...
 */
require_once LIB_DIR.'/Zend/Amf/Value/Messaging/AsyncMessage.php';
/**
 ...
 */
require_once LIB_DIR.'/Zend/Amf/Value/Messaging/RemotingMessage.php';
...
final class Zend_Amf_Parse_TypeLoader
{
    ...
    {
        if(!self::$_resourceLoader) {
            require_once LIB_DIR.'/Zend/Amf/Exception.php';
