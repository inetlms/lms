 ...
 */
require_once LIB_DIR.'/Zend/Barcode/Object/Ean13.php';

/**
 * @see Zend_Validate_Barcode
 */
require_once LIB_DIR.'/Zend/Validate/Barcode.php';
...
class Zend_Barcode_Object_Ean8 extends Zend_Barcode_Object_Ean13
{
    ...
    protected function _validateText($value, $options = array())
    {
        ...
        if (!$validator->isValid($value)) {
             ...
             */
            require_once LIB_DIR.'/Zend/Barcode/Object/Exception.php';
