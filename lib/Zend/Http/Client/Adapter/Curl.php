 ...
 */
require_once LIB_DIR.'/Zend/Http/Client/Adapter/Interface.php';
/**
 * @see Zend_Http_Client_Adapter_Stream
 */
require_once LIB_DIR.'/Zend/Http/Client/Adapter/Stream.php';
...
class Zend_Http_Client_Adapter_Curl implements Zend_Http_Client_Adapter_Interface, Zend_Http_Client_Adapter_Stream
{
    ...
    public function __construct()
    {
        if (!extension_loaded('curl')) {
            require_once LIB_DIR.'/Zend/Http/Client/Adapter/Exception.php';
