...
/** @see Zend_Filter */
require_once LIB_DIR.'/Zend/Filter.php';

/** @see Zend_Form */
require_once LIB_DIR.'/Zend/Form.php';

/** @see Zend_Validate_Interface */
require_once LIB_DIR.'/Zend/Validate/Interface.php';

/** @see Zend_Validate_Abstract */
require_once LIB_DIR.'/Zend/Validate/Abstract.php';
...
class Zend_Form_Element implements Zend_Validate_Interface
{
    ...
    public function __construct($spec, $options = null)
    {
        ...
        if (null === $this->getName()) {
            require_once LIB_DIR.'/Zend/Form/Exception.php';
    ...
    public function __call($method, $args)
    {
        if ('render' == substr($method, 0, 6)) {
            ...
            require_once LIB_DIR.'/Zend/Form/Element/Exception.php';
