...
require_once LIB_DIR.'/Zend/Search/Lucene/Document/Html.php';

/** Zend_Search_Lucene_Document_Docx */
require_once LIB_DIR.'/Zend/Search/Lucene/Document/Docx.php';

/** Zend_Search_Lucene_Document_Pptx */
require_once LIB_DIR.'/Zend/Search/Lucene/Document/Pptx.php';

/** Zend_Search_Lucene_Document_Xlsx */
require_once LIB_DIR.'/Zend/Search/Lucene/Document/Xlsx.php';

/** Zend_Search_Lucene_Search_QueryParser */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/QueryParser.php';

/** Zend_Search_Lucene_Search_QueryHit */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/QueryHit.php';

/** Zend_Search_Lucene_Analysis_Analyzer */
require_once LIB_DIR.'/Zend/Search/Lucene/Analysis/Analyzer.php';

/** Zend_Search_Lucene_Search_Query_Term */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query/Term.php';

/** Zend_Search_Lucene_Search_Query_Phrase */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query/Phrase.php';

/** Zend_Search_Lucene_Search_Query_MultiTerm */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query/MultiTerm.php';

/** Zend_Search_Lucene_Search_Query_Wildcard */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query/Wildcard.php';

/** Zend_Search_Lucene_Search_Query_Range */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query/Range.php';

/** Zend_Search_Lucene_Search_Query_Fuzzy */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query/Fuzzy.php';

/** Zend_Search_Lucene_Search_Query_Boolean */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query/Boolean.php';

/** Zend_Search_Lucene_Search_Query_Empty */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query/Empty.php';

/** Zend_Search_Lucene_Search_Query_Insignificant */
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query/Insignificant.php';
...
require_once LIB_DIR.'/Zend/Search/Lucene/Interface.php';

/** Zend_Search_Lucene_Index_SegmentInfo */
require_once LIB_DIR.'/Zend/Search/Lucene/Index/SegmentInfo.php';

/** Zend_Search_Lucene_LockManager */
require_once LIB_DIR.'/Zend/Search/Lucene/LockManager.php';
...
class Zend_Search_Lucene implements Zend_Search_Lucene_Interface
{
    ...
    public static function create($directory)
    {
        ...
        require_once LIB_DIR.'/Zend/Search/Lucene/Proxy.php';
    ...
    public function getSimilarity()
    {
        ...
        require_once LIB_DIR.'/Zend/Search/Lucene/Search/Similarity.php';
    ...
    public function terms()
    {
        ...
        require_once LIB_DIR.'/Zend/Search/Lucene/Index/TermsPriorityQueue.php';
    ...
    public function resetTermsStream()
    {
        if ($this->_termsStream === null) {
            ...
            require_once LIB_DIR.'/Zend/Search/Lucene/TermStreamsPriorityQueue.php';
