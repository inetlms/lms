...
require_once LIB_DIR.'/Zend/Search/Lucene/Index/TermsStream/Interface.php';
...
require_once LIB_DIR.'/Zend/Search/Lucene/Index/FieldInfo.php';

/** Zend_Search_Lucene_Index_Term */
require_once LIB_DIR.'/Zend/Search/Lucene/Index/Term.php';

/** Zend_Search_Lucene_Index_TermInfo */
require_once LIB_DIR.'/Zend/Search/Lucene/Index/TermInfo.php';
...
class Zend_Search_Lucene_Index_SegmentInfo implements Zend_Search_Lucene_Index_TermsStream_Interface
{
    ...
    private function _loadDictionaryIndex()
    {
        ...
        require_once LIB_DIR.'/Zend/Search/Lucene/Index/DictionaryLoader.php';
