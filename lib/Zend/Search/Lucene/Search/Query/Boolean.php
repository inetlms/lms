...
require_once LIB_DIR.'/Zend/Search/Lucene/Search/Query.php';
...
class Zend_Search_Lucene_Search_Query_Boolean extends Zend_Search_Lucene_Search_Query
{
    ...
    {
        require_once LIB_DIR.'/Zend/Search/Lucene/Search/Weight/Boolean.php';
    ...
    public function execute(Zend_Search_Lucene_Interface $reader, $docsFilter = null)
    {
        ...
        if ($docsFilter === null) {
            ...
            require_once LIB_DIR.'/Zend/Search/Lucene/Index/DocsFilter.php';
