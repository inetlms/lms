...
require_once LIB_DIR.'/Zend/Search/Lucene/Search/QueryToken.php';



/** Zend_Search_Lucene_FSM */
require_once LIB_DIR.'/Zend/Search/Lucene/FSM.php';
...
class Zend_Search_Lucene_Search_QueryParser extends Zend_Search_Lucene_FSM
{
    ...
    public function __construct()
    {
        ...
        require_once LIB_DIR.'/Zend/Search/Lucene/Search/QueryLexer.php';
    ...
    public static function parse($strQuery, $encoding = null)
    {
        ...
        require_once LIB_DIR.'/Zend/Search/Lucene/Search/QueryParserException.php';
        try {
            require_once LIB_DIR.'/Zend/Search/Lucene/Search/QueryParserContext.php';
            ...
            if (self::$_instance->_suppressQueryParsingExceptions) {
                ...
                require_once LIB_DIR.'/Zend/Search/Lucene/Index/Term.php';
    ...
    {
        require_once LIB_DIR.'/Zend/Search/Lucene/Search/QueryEntry/Term.php';
    ...
    {
        require_once LIB_DIR.'/Zend/Search/Lucene/Search/QueryEntry/Phrase.php';
    ...
    public function subqueryEnd()
    {
        ...
        require_once LIB_DIR.'/Zend/Search/Lucene/Search/QueryEntry/Subquery.php';
