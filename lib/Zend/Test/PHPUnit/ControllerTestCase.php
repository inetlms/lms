...
require_once LIB_DIR.'/Zend/Controller/Front.php';

/** @see Zend_Controller_Action_HelperBroker */
require_once LIB_DIR.'/Zend/Controller/Action/HelperBroker.php';

/** @see Zend_Layout */
require_once LIB_DIR.'/Zend/Layout.php';
...
abstract class Zend_Test_PHPUnit_ControllerTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function assertQuery($path, $message = '')
    {
        ...
        require_once LIB_DIR.'/Zend/Test/PHPUnit/Constraint/DomQuery.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once LIB_DIR.'/Zend/Test/PHPUnit/Constraint/Redirect.php';
    ...
    {
        $this->_incrementAssertionCount();
        require_once LIB_DIR.'/Zend/Test/PHPUnit/Constraint/ResponseHeader.php';
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            require_once LIB_DIR.'/Zend/Controller/Request/HttpTestCase.php';
    ...
    public function getResponse()
    {
        if (null === $this->_response) {
            require_once LIB_DIR.'/Zend/Controller/Response/HttpTestCase.php';
    ...
    {
        if (null === $this->_query) {
            require_once LIB_DIR.'/Zend/Dom/Query.php';
