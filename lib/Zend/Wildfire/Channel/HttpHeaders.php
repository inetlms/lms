...
require_once LIB_DIR.'/Zend/Wildfire/Channel/Interface.php';
...
require_once LIB_DIR.'/Zend/Controller/Plugin/Abstract.php';

/** Zend_Wildfire_Protocol_JsonStream */
require_once LIB_DIR.'/Zend/Wildfire/Protocol/JsonStream.php';
