 ...
 * Zend_Gdata_Feed
 */
require_once LIB_DIR.'/Zend/Gdata/App/Feed.php';
 ...
 */
require_once LIB_DIR.'/Zend/Gdata/App/MediaSource.php';

/**
 * Zend_Uri/Http
 */
require_once LIB_DIR.'/Zend/Uri/Http.php';
        ...
        $body = null, $contentType = null, $remainingRedirects = null)
    {
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once LIB_DIR.'/Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once LIB_DIR.'/Zend/Gdata/HttpAdapterStreamingSocket.php';
