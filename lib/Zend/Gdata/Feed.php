 ...
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/OpenSearchTotalResults.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchStartIndex
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/OpenSearchStartIndex.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchItemsPerPage
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/OpenSearchItemsPerPage.php';
