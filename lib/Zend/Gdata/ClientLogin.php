 ...
 */
require_once LIB_DIR.'/Zend/Gdata/HttpClient.php';
...
class Zend_Gdata_ClientLogin
{
    ...
    {
        if (! ($email && $password)) {
            require_once LIB_DIR.'/Zend/Gdata/App/AuthException.php';
        ...
        if ($response->getStatus() == 200) {
            ...
            if (array_key_exists('Error', $goog_resp) &&
                ...
                require_once LIB_DIR.'/Zend/Gdata/App/CaptchaRequiredException.php';
