 ...
 */
require_once LIB_DIR.'/Zend/Gdata/Analytics/Extension/Dimension.php';

/**
 * @see Zend_Gdata_Analytics_Extension_Metric
 */
require_once LIB_DIR.'/Zend/Gdata/Analytics/Extension/Metric.php';

/**
 * @see Zend_Gdata_Analytics_Extension_Property
 */
require_once LIB_DIR.'/Zend/Gdata/Analytics/Extension/Property.php';

/**
 * @see Zend_Gdata_Analytics_Extension_TableId
 */
require_once LIB_DIR.'/Zend/Gdata/Analytics/Extension/TableId.php';
