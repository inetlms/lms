 ...
 */
require_once LIB_DIR.'/Zend/Gdata/Gapps/Extension/Login.php';

/**
 * @see Zend_Gdata_Gapps_Extension_Name
 */
require_once LIB_DIR.'/Zend/Gdata/Gapps/Extension/Name.php';

/**
 * @see Zend_Gdata_Gapps_Extension_Quota
 */
require_once LIB_DIR.'/Zend/Gdata/Gapps/Extension/Quota.php';
