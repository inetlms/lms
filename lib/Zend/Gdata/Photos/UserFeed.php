 ...
 */
require_once LIB_DIR.'/Zend/Gdata/Photos.php';

/**
 * @see Zend_Gdata_Feed
 */
require_once LIB_DIR.'/Zend/Gdata/Feed.php';

/**
 * @see Zend_Gdata_Photos_UserEntry
 */
require_once LIB_DIR.'/Zend/Gdata/Photos/UserEntry.php';

/**
 * @see Zend_Gdata_Photos_AlbumEntry
 */
require_once LIB_DIR.'/Zend/Gdata/Photos/AlbumEntry.php';

/**
 * @see Zend_Gdata_Photos_PhotoEntry
 */
require_once LIB_DIR.'/Zend/Gdata/Photos/PhotoEntry.php';

/**
 * @see Zend_Gdata_Photos_TagEntry
 */
require_once LIB_DIR.'/Zend/Gdata/Photos/TagEntry.php';

/**
 * @see Zend_Gdata_Photos_CommentEntry
 */
require_once LIB_DIR.'/Zend/Gdata/Photos/CommentEntry.php';
