 ...
 */
require_once LIB_DIR.'/Zend/Gdata/Photos/UserFeed.php';

/**
 * @see Zend_Gdata_Photos_AlbumFeed
 */
require_once LIB_DIR.'/Zend/Gdata/Photos/AlbumFeed.php';

/**
 * @see Zend_Gdata_Photos_PhotoFeed
 */
require_once LIB_DIR.'/Zend/Gdata/Photos/PhotoFeed.php';
