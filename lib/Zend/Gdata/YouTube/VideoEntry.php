 ...
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/MediaEntry.php';

/**
 * @see Zend_Gdata_YouTube_Extension_MediaGroup
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/Extension/MediaGroup.php';

/**
 * @see Zend_Gdata_YouTube_Extension_NoEmbed
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/Extension/NoEmbed.php';
 ...
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/Extension/Link.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Racy
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/Extension/Racy.php';
 ...
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/Extension/Control.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Recorded
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/Extension/Recorded.php';
