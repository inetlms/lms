 ...
 */
require_once LIB_DIR.'/Zend/Gdata/Calendar/EventFeed.php';

/**
 * @see Zend_Gdata_Calendar_EventEntry
 */
require_once LIB_DIR.'/Zend/Gdata/Calendar/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_ListFeed
 */
require_once LIB_DIR.'/Zend/Gdata/Calendar/ListFeed.php';

/**
 * @see Zend_Gdata_Calendar_ListEntry
 */
require_once LIB_DIR.'/Zend/Gdata/Calendar/ListEntry.php';
