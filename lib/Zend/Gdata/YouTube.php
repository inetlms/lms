 ...
 */
require_once LIB_DIR.'/Zend/Gdata/Media.php';

/**
 * @see Zend_Gdata_YouTube_VideoEntry
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/VideoEntry.php';

/**
 * @see Zend_Gdata_YouTube_VideoFeed
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/VideoFeed.php';

/**
 * @see Zend_Gdata_YouTube_CommentFeed
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/CommentFeed.php';

/**
 * @see Zend_Gdata_YouTube_PlaylistListFeed
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/PlaylistListFeed.php';

/**
 * @see Zend_Gdata_YouTube_SubscriptionFeed
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/SubscriptionFeed.php';

/**
 * @see Zend_Gdata_YouTube_ContactFeed
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/ContactFeed.php';

/**
 * @see Zend_Gdata_YouTube_PlaylistVideoFeed
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/PlaylistVideoFeed.php';

/**
 * @see Zend_Gdata_YouTube_ActivityFeed
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/ActivityFeed.php';

/**
 * @see Zend_Gdata_YouTube_InboxFeed
 */
require_once LIB_DIR.'/Zend/Gdata/YouTube/InboxFeed.php';
...
class Zend_Gdata_YouTube extends Zend_Gdata_Media
{
        ...
        $developerKey = null)
    {
        ...
        if (!$client instanceof Zend_Http_Client) {
            require_once LIB_DIR.'/Zend/Gdata/App/HttpException.php';
