 ...
 */
require_once LIB_DIR.'/Zend/Gdata/App/Extension.php';

/**
 * @see Zend_Gdata_Extension_Where
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/Where.php';

/**
 * @see Zend_Gdata_Extension_When
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/When.php';

/**
 * @see Zend_Gdata_Extension_Who
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/Who.php';

/**
 * @see Zend_Gdata_Extension_Recurrence
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/Recurrence.php';

/**
 * @see Zend_Gdata_Extension_EventStatus
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/EventStatus.php';
 ...
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/Transparency.php';

/**
 * @see Zend_Gdata_Extension_Visibility
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/Visibility.php';

/**
 * @see Zend_Gdata_Extension_ExtendedProperty
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/ExtendedProperty.php';

/**
 * @see Zend_Gdata_Extension_OriginalEvent
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/OriginalEvent.php';

/**
 * @see Zend_Gdata_Extension_EntryLink
 */
require_once LIB_DIR.'/Zend/Gdata/Extension/EntryLink.php';
...
class Zend_Gdata_Kind_EventEntry extends Zend_Gdata_Entry
{
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        case $this->lookupNamespace('gd') . ':' . 'recurrenceException';
            require_once LIB_DIR.'/Zend/Gdata/Extension/RecurrenceException.php';
