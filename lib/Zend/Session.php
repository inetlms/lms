 ...
 */
require_once LIB_DIR.'/Zend/Session/Abstract.php';

/**
 * @see Zend_Session_Namespace
 */
require_once LIB_DIR.'/Zend/Session/Namespace.php';

/**
 * @see Zend_Session_SaveHandler_Interface
 */
require_once LIB_DIR.'/Zend/Session/SaveHandler/Interface.php';
    ...
    public static function setOptions(array $userOptions = array())
    {
        ...
        foreach ($userOptions as $userOptionName => $userOptionValue) {
            ...
            elseif (isset(self::$_localOptions[$userOptionName])) {
                ...
                require_once LIB_DIR.'/Zend/Session/Exception.php';
