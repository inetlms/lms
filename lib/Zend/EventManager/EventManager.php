...
require_once LIB_DIR.'/Zend/EventManager/Event.php';
require_once LIB_DIR.'/Zend/EventManager/EventCollection.php';
require_once LIB_DIR.'/Zend/EventManager/ResponseCollection.php';
require_once LIB_DIR.'/Zend/EventManager/SharedEventCollectionAware.php';
require_once LIB_DIR.'/Zend/EventManager/StaticEventManager.php';
require_once LIB_DIR.'/Zend/Stdlib/CallbackHandler.php';
require_once LIB_DIR.'/Zend/Stdlib/PriorityQueue.php';
...
class Zend_EventManager_EventManager implements Zend_EventManager_EventCollection, Zend_EventManager_SharedEventCollectionAware
{
    ...
    public function trigger($event, $target = null, $argv = array(), $callback = null)
    {
        ...
        if ($callback && !is_callable($callback)) {
            require_once LIB_DIR.'/Zend/Stdlib/Exception/InvalidCallbackException.php';
    ...
    public function attach($event, $callback = null, $priority = 1)
    {
        ...
        if (null === $callback) {
            require_once LIB_DIR.'/Zend/EventManager/Exception/InvalidArgumentException.php';
