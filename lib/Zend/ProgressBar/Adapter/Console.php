 ...
 */
require_once LIB_DIR.'/Zend/ProgressBar/Adapter.php';

/**
 * @see Zend_Text_MultiByte
 */
require_once LIB_DIR.'/Zend/Text/MultiByte.php';
...
class Zend_ProgressBar_Adapter_Console extends Zend_ProgressBar_Adapter
{
    ...
    public function setOutputStream($resource)
    {
       ...
       if ($stream === false) {
            require_once LIB_DIR.'/Zend/ProgressBar/Adapter/Exception.php';
