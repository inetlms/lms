 ...
 */
require_once LIB_DIR.'/Zend/Server/Definition.php';

/**
 * Zend_Server_Method_Definition
 */
require_once LIB_DIR.'/Zend/Server/Method/Definition.php';

/**
 * Zend_Server_Method_Callback
 */
require_once LIB_DIR.'/Zend/Server/Method/Callback.php';

/**
 * Zend_Server_Method_Prototype
 */
require_once LIB_DIR.'/Zend/Server/Method/Prototype.php';

/**
 * Zend_Server_Method_Parameter
 */
require_once LIB_DIR.'/Zend/Server/Method/Parameter.php';
