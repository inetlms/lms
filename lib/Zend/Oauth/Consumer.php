...
require_once LIB_DIR.'/Zend/Oauth/Http/RequestToken.php';

/** Zend_Oauth_Http_UserAuthorization */
require_once LIB_DIR.'/Zend/Oauth/Http/UserAuthorization.php';

/** Zend_Oauth_Http_AccessToken */
require_once LIB_DIR.'/Zend/Oauth/Http/AccessToken.php';

/** Zend_Oauth_Token_AuthorizedRequest */
require_once LIB_DIR.'/Zend/Oauth/Token/AuthorizedRequest.php';

/** Zend_Oauth_Config */
require_once LIB_DIR.'/Zend/Oauth/Config.php';
...
class Zend_Oauth_Consumer extends Zend_Oauth
{
    ...
    public function getAccessToken(
        ...
        if (!$authorizedToken->isValid()) {
            require_once LIB_DIR.'/Zend/Oauth/Exception.php';
