 ...
 */
require_once LIB_DIR.'/Zend/Controller/Router/Route/Interface.php';

/**
 * @see Zend_Controller_Router_Route_Module
 */
require_once LIB_DIR.'/Zend/Controller/Router/Route/Module.php';

/**
 * @see Zend_Controller_Dispatcher_Interface
 */
require_once LIB_DIR.'/Zend/Controller/Dispatcher/Interface.php';

/**
 * @see Zend_Controller_Request_Abstract
 */
require_once LIB_DIR.'/Zend/Controller/Request/Abstract.php';
