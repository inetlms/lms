 ...
 */
require_once LIB_DIR.'/Zend/Server/Abstract.php';

/**
 * XMLRPC Request
 */
require_once LIB_DIR.'/Zend/XmlRpc/Request.php';

/**
 * XMLRPC Response
 */
require_once LIB_DIR.'/Zend/XmlRpc/Response.php';

/**
 * XMLRPC HTTP Response
 */
require_once LIB_DIR.'/Zend/XmlRpc/Response/Http.php';

/**
 * XMLRPC server fault class
 */
require_once LIB_DIR.'/Zend/XmlRpc/Server/Fault.php';

/**
 * XMLRPC server system methods class
 */
require_once LIB_DIR.'/Zend/XmlRpc/Server/System.php';

/**
 * Convert PHP to and from xmlrpc native types
 */
require_once LIB_DIR.'/Zend/XmlRpc/Value.php';
 ...
 */
require_once LIB_DIR.'/Zend/Server/Reflection/Function/Abstract.php';
 ...
 */
require_once LIB_DIR.'/Zend/Server/Reflection/Method.php';
 ...
 * Example:
 * <code>
 * require_once LIB_DIR.'/Zend/XmlRpc/Server.php';
 * require_once LIB_DIR.'/Zend/XmlRpc/Server/Cache.php';
 * require_once LIB_DIR.'/Zend/XmlRpc/Server/Fault.php';
...
class Zend_XmlRpc_Server extends Zend_Server_Abstract
{
    ...
    public function __call($method, $params)
    {
        ...
        if (!method_exists($system, $method)) {
            require_once LIB_DIR.'/Zend/XmlRpc/Server/Exception.php';
    ...
    public function handle($request = false)
    {
        ...
        if ((!$request || !$request instanceof Zend_XmlRpc_Request)
            ...
            require_once LIB_DIR.'/Zend/XmlRpc/Request/Http.php';
