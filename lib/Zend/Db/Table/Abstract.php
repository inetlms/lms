 ...
 */
require_once LIB_DIR.'/Zend/Db/Adapter/Abstract.php';
...
abstract class Zend_Db_Table_Abstract
{
    ...
    protected static function _setupAdapter($db)
    {
        ...
        if (!$db instanceof Zend_Db_Adapter_Abstract) {
            require_once LIB_DIR.'/Zend/Db/Table/Exception.php';
    ...
    {
        require_once LIB_DIR.'/Zend/Db/Table/Select.php';
    ...
    public static function getTableFromString($tableName, Zend_Db_Table_Abstract $referenceTable = null)
    {
        ...
        if (!class_exists($tableName)) {
            try {
                ...
                require_once LIB_DIR.'/Zend/Db/Table/Row/Exception.php';
