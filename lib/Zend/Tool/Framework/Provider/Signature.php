 ...
 */
require_once LIB_DIR.'/Zend/Reflection/Class.php';
 ...
 */
require_once LIB_DIR.'/Zend/Tool/Framework/Action/Base.php';
    ...
    protected function _processSpecialties()
    {
        ...
        if ($this->_providerReflection->hasMethod('getSpecialties')) {
            ...
            if (!is_array($specialties)) {
                require_once LIB_DIR.'/Zend/Tool/Framework/Provider/Exception.php';
