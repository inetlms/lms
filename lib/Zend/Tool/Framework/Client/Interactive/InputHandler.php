...
class Zend_Tool_Framework_Client_Interactive_InputHandler
{
    ...
    public function setInputRequest($inputRequest)
    {
        if (is_string($inputRequest)) {
            require_once LIB_DIR.'/Zend/Tool/Framework/Client/Interactive/InputRequest.php';
    ...
    public function handle()
    {
        ...
        if (is_string($inputResponse)) {
            require_once LIB_DIR.'/Zend/Tool/Framework/Client/Interactive/InputResponse.php';
