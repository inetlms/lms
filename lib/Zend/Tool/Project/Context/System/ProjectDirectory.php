 ...
 */
require_once LIB_DIR.'/Zend/Tool/Project/Context/Filesystem/Directory.php';

/**
 * @see Zend_Tool_Project_Context_System_Interface
 */
require_once LIB_DIR.'/Zend/Tool/Project/Context/System/Interface.php';

/**
 * @see Zend_Tool_Project_Context_System_TopLevelRestrictable
 */
require_once LIB_DIR.'/Zend/Tool/Project/Context/System/TopLevelRestrictable.php';

/**
 * @see Zend_Tool_Project_Context_System_NotOverwritable
 */
require_once LIB_DIR.'/Zend/Tool/Project/Context/System/NotOverwritable.php';
            ...
            foreach (new DirectoryIterator($this->getPath()) as $item) {
                if (!$item->isDot()) {
                    if ($registry->getClient()->isInteractive()) {
                        ...
                        require_once LIB_DIR.'/Zend/Tool/Project/Context/Exception.php';
