 ...
 */
require_once LIB_DIR.'/Zend/Queue/Adapter/AdapterAbstract.php';

/**
 * @see Zend_Db_Select
 */
require_once LIB_DIR.'/Zend/Db/Select.php';

/**
 * @see Zend_Db
 */
require_once LIB_DIR.'/Zend/Db.php';

/**
 * @see Zend_Queue_Adapter_Db_Queue
 */
require_once LIB_DIR.'/Zend/Queue/Adapter/Db/Queue.php';

/**
 * @see Zend_Queue_Adapter_Db_Message
 */
require_once LIB_DIR.'/Zend/Queue/Adapter/Db/Message.php';
...
class Zend_Queue_Adapter_Db extends Zend_Queue_Adapter_AdapterAbstract
{
    ...
    public function __construct($options, Zend_Queue $queue = null)
    {
        ...
        if (!is_bool($this->_options['options'][Zend_Db_Select::FOR_UPDATE])) {
            require_once LIB_DIR.'/Zend/Queue/Exception.php';
