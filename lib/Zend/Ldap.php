...
class Zend_Ldap
{
    ...
    public static function filterEscape($str)
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Ldap/Filter/Abstract.php';
    ...
    public static function explodeDn($dn, array &$keys = null, array &$vals = null)
    {
         ...
         * @see Zend_Ldap_Dn
         */
        require_once LIB_DIR.'/Zend/Ldap/Dn.php';
    ...
    public function __construct($options = array())
    {
        if (!extension_loaded('ldap')) {
             ...
             */
            require_once LIB_DIR.'/Zend/Ldap/Exception.php';
        ...
        $sort = null, $collectionClass = null, $sizelimit = 0, $timelimit = 0)
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Ldap/Collection/Iterator/Default.php';
    ...
    protected function _createCollection(Zend_Ldap_Collection_Iterator_Default $iterator, $collectionClass)
    {
        if ($collectionClass === null) {
             ...
             */
            require_once LIB_DIR.'/Zend/Ldap/Collection.php';
    ...
    public function getNode($dn)
    {
         ...
         * Zend_Ldap_Node
         */
        require_once LIB_DIR.'/Zend/Ldap/Node.php';
    ...
    public function getRootDse()
    {
        if ($this->_rootDse === null) {
             ...
             */
            require_once LIB_DIR.'/Zend/Ldap/Node/RootDse.php';
    ...
    public function getSchema()
    {
        if ($this->_schema === null) {
             ...
             * @see Zend_Ldap_Node_Schema
             */
            require_once LIB_DIR.'/Zend/Ldap/Node/Schema.php';
