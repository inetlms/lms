 ...
 */
require_once LIB_DIR.'/Zend/Json/Decoder.php';

/**
 * @see Zend_Service_Delicious_SimplePost
 */
require_once LIB_DIR.'/Zend/Service/Delicious/SimplePost.php';

/**
 * @see Zend_Service_Delicious_Post
 */
require_once LIB_DIR.'/Zend/Service/Delicious/Post.php';

/**
 * @see Zend_Service_Delicious_PostList
 */
require_once LIB_DIR.'/Zend/Service/Delicious/PostList.php';
...
class Zend_Service_Delicious
{
    ...
    public function getLastUpdate()
    {
        ...
        if ($rootNode && $rootNode->nodeName == 'update') {
             ...
             */
            require_once LIB_DIR.'/Zend/Service/Delicious/Exception.php';
