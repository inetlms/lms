 ...
 */
require_once LIB_DIR.'/Zend/Service/Technorati/ResultSet.php';
...
class Zend_Service_Technorati_CosmosResultSet extends Zend_Service_Technorati_ResultSet
{
    ...
    public function __construct(DomDocument $dom, $options = array())
    {
        ...
        if ($result->length == 1) {
             ...
             */
            require_once LIB_DIR.'/Zend/Service/Technorati/Weblog.php';
    ...
    public function current()
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Service/Technorati/CosmosResult.php';
