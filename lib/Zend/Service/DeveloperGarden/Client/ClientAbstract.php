 ...
 */
require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Client/Soap.php';

/**
 * @see Zend_Service_DeveloperGarden_Credential
 */
require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Credential.php';

/**
 * @see Zend_Service_DeveloperGarden_SecurityTokenServer
 */
require_once LIB_DIR.'/Zend/Service/DeveloperGarden/SecurityTokenServer.php';
...
abstract class Zend_Service_DeveloperGarden_Client_ClientAbstract
{
    ...
    public function __construct(array $options = array())
    {
        ...
        if (empty($this->_wsdlFile)) {
            require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Exception.php';
