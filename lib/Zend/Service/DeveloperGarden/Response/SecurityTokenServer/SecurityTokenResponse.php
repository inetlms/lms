 ...
 */
require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Response/ResponseAbstract.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SecurityTokenServer_Interface
 */
require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Response/SecurityTokenServer/Interface.php';
    ...
    implements Zend_Service_DeveloperGarden_Response_SecurityTokenServer_Interface
{
    ...
    public function getTokenData()
    {
        if (empty($this->tokenData)) {
            require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Response/Exception.php';
