 ...
 */
require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Response/SendSms/SendSMSResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_SendSms_SendFlashSMSResponse
 */
require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Response/SendSms/SendFlashSMSResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_SendSms_SendSMS
 */
require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Request/SendSms/SendSMS.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_SendSms_SendFlashSMS
 */
require_once LIB_DIR.'/Zend/Service/DeveloperGarden/Request/SendSms/SendFlashSMS.php';
