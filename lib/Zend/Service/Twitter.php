 ...
 */
require_once LIB_DIR.'/Zend/Http/CookieJar.php';

/**
 * @see Zend_Oauth_Consumer
 */
require_once LIB_DIR.'/Zend/Oauth/Consumer.php';

/**
 * @see Zend_Oauth_Token_Access
 */
require_once LIB_DIR.'/Zend/Oauth/Token/Access.php';

/**
 * @see Zend_Service_Twitter_Response
 */
require_once LIB_DIR.'/Zend/Service/Twitter/Response.php';
...
class Zend_Service_Twitter
{
    ...
    public function __get($type)
    {
        ...
        if (!in_array($type, $this->methodTypes)) {
            require_once LIB_DIR.'/Zend/Service/Twitter/Exception.php';
