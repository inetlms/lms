 ...
 */
 require_once LIB_DIR.'/Zend/Service/WindowsAzure/RetryPolicy/RetryPolicyAbstract.php';
 
 /**
 * @see Zend_Service_SqlAzure_Management_ServerInstance
 */
 require_once LIB_DIR.'/Zend/Service/SqlAzure/Management/ServerInstance.php';
 
 /**
 * @see Zend_Service_SqlAzure_Management_FirewallRuleInstance
 */
 require_once LIB_DIR.'/Zend/Service/SqlAzure/Management/FirewallRuleInstance.php';
...
class Zend_Service_SqlAzure_Management_Client
{
	...
	{
		if (is_null($response)) {
			require_once LIB_DIR.'/Zend/Service/SqlAzure/Exception.php';
	...
	public function createServer($administratorLogin, $administratorPassword, $location)
	{
		if ($administratorLogin == '' || is_null($administratorLogin)) {
                    require_once LIB_DIR.'/Zend/Service/SqlAzure/Management/Exception.php';
