 ...
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/OperationStatusInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_SubscriptionOperationInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/SubscriptionOperationInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_DeploymentInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/DeploymentInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_Blob
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage/Blob.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_Table
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage/Table.php';

/**
 * @see Zend_Service_WindowsAzure_Management_HostedServiceInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/HostedServiceInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_CertificateInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/CertificateInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_AffinityGroupInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/AffinityGroupInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_LocationInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/LocationInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_OperatingSystemInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/OperatingSystemInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Management_OperatingSystemFamilyInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/OperatingSystemFamilyInstance.php';
...
class Zend_Service_WindowsAzure_Management_Client
{
	...
	{
		if (is_null($response)) {
			require_once LIB_DIR.'/Zend/Service/WindowsAzure/Exception.php';
    ...
    public function getOperationStatus($requestId = '')
    {
    	...
    	if ($response->isSuccessful()) {
			...
			require_once LIB_DIR.'/Zend/Service/Management/Exception.php';
    ...
    public function listSubscriptionOperations($startTime, $endTime, $objectIdFilter = null, $operationResultFilter = null, $continuationToken = null)
    {
    	if ($startTime == '' || is_null($startTime)) {
			require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/Exception.php';
	...
	public function createQueueClientForService($serviceName, Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy = null)
	{
		...
		require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage/Queue.php';
    ...
    public function getStorageAccountProperties($serviceName)
    {
    	...
    	if ($response->isSuccessful()) {
			...
			if (!is_null($xmlService)) {
				require_once LIB_DIR.'/Zend/Service/WindowsAzure/Management/StorageServiceInstance.php';
