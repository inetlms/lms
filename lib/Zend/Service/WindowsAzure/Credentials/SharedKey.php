 ...
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Credentials/CredentialsAbstract.php';
    ...
    extends Zend_Service_WindowsAzure_Credentials_CredentialsAbstract
{
	...
	public function signRequestHeaders(
		...
		// Table storage?
		if ($forTableStorage) {
			require_once LIB_DIR.'/Zend/Service/WindowsAzure/Credentials/Exception.php';
