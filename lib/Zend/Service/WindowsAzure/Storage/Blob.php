 ...
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_BlobInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage/BlobInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_BlobContainer
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage/BlobContainer.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_PageRegionInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage/PageRegionInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_LeaseInstance
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage/LeaseInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_Blob_Stream
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage/Blob/Stream.php';

/**
 * @see Zend_Service_WindowsAzure_Credentials_SharedAccessSignature
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Credentials/SharedAccessSignature.php';
/**
 * @category   Zend
 * @package    Zend_Service_WindowsAzure
 * @subpackage Storage
	...
	public function getContainerAcl($containerName = '', $signedIdentifiers = false)
	{
		...
		if ($response->isSuccessful()) {
			if ($signedIdentifiers == false)  {
				...
				require_once LIB_DIR.'/Zend/Service/WindowsAzure/Storage/SignedIdentifier.php';
				// Return value
				$returnValue = array();
