 ...
 */
require_once LIB_DIR.'/Zend/Service/WindowsAzure/Diagnostics/ConfigurationInstance.php';
...
class Zend_Service_WindowsAzure_Diagnostics_Manager
{
	...
	public function configurationForRoleInstanceExists($roleInstance = null)
	{
		if (is_null($roleInstance)) {
			require_once LIB_DIR.'/Zend/Service/WindowsAzure/Diagnostics/Exception.php';
