 ...
 */
require_once LIB_DIR.'/Zend/Service/Abstract.php';

/**
 * @see Zend_Service_ShortUrl_Shortener
 */
require_once LIB_DIR.'/Zend/Service/ShortUrl/Shortener.php';
    ...
    implements Zend_Service_ShortUrl_Shortener
{
    ...
    protected function _validateUri($url)
    {
        ...
        if (!Zend_Uri::check($url)) {
            require_once LIB_DIR.'/Zend/Service/ShortUrl/Exception.php';
