...
require_once LIB_DIR.'/Zend/Service/Rackspace/Abstract.php';
require_once LIB_DIR.'/Zend/Service/Rackspace/Servers/Server.php';
require_once LIB_DIR.'/Zend/Service/Rackspace/Servers/ServerList.php';
require_once LIB_DIR.'/Zend/Service/Rackspace/Servers/Image.php';
require_once LIB_DIR.'/Zend/Service/Rackspace/Servers/ImageList.php';
require_once LIB_DIR.'/Zend/Service/Rackspace/Servers/SharedIpGroup.php';
require_once LIB_DIR.'/Zend/Service/Rackspace/Servers/SharedIpGroupList.php';
require_once LIB_DIR.'/Zend/Validate/Ip.php';
...
class Zend_Service_Rackspace_Servers extends Zend_Service_Rackspace_Abstract
{
    ...
    {
        if (empty($id)) {
            require_once LIB_DIR.'/Zend/Service/Rackspace/Exception.php';
