 ...
 */
require_once LIB_DIR.'/Zend/CodeGenerator/Php/Member/Container.php';

/**
 * @see Zend_CodeGenerator_Php_Method
 */
require_once LIB_DIR.'/Zend/CodeGenerator/Php/Method.php';

/**
 * @see Zend_CodeGenerator_Php_Property
 */
require_once LIB_DIR.'/Zend/CodeGenerator/Php/Property.php';

/**
 * @see Zend_CodeGenerator_Php_Docblock
 */
require_once LIB_DIR.'/Zend/CodeGenerator/Php/Docblock.php';
...
class Zend_CodeGenerator_Php_Class extends Zend_CodeGenerator_Php_Abstract
{
    ...
    public function setDocblock($docblock)
    {
        ...
        if (is_array($docblock)) {
            ...
            require_once LIB_DIR.'/Zend/CodeGenerator/Php/Exception.php';
