 ...
 */
require_once LIB_DIR.'/Zend/Date/DateObject.php';
require_once LIB_DIR.'/Zend/Locale.php';
require_once LIB_DIR.'/Zend/Locale/Format.php';
require_once LIB_DIR.'/Zend/Locale/Math.php';
                ...
                switch($name) {
                    case 'format_type' :
                        if ((strtolower($value) != 'php') && (strtolower($value) != 'iso')) {
                            require_once LIB_DIR.'/Zend/Date/Exception.php';
