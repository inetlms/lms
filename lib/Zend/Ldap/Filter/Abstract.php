...
abstract class Zend_Ldap_Filter_Abstract
{
    ...
    public function negate()
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Ldap/Filter/Not.php';
    ...
    public function addAnd($filter)
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Ldap/Filter/And.php';
        $fa = func_get_args();
    ...
    public function addOr($filter)
    {
         ...
         * Zend_Ldap_Filter_Or
         */
        require_once LIB_DIR.'/Zend/Ldap/Filter/Or.php';
        $fa = func_get_args();
        $args = array_merge(array($this), $fa);
    ...
    public static function escapeValue($values = array())
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Ldap/Converter.php';
