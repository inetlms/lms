 ...
 * @see Zend_Ldap
 */
require_once LIB_DIR.'/Zend/Ldap.php';
/**
 * @see Zend_Ldap_Node_Abstract
 */
require_once LIB_DIR.'/Zend/Ldap/Node/Abstract.php';
...
class Zend_Ldap_Node extends Zend_Ldap_Node_Abstract implements Iterator, RecursiveIterator
{
    ...
    */
    ...
    public function toLdif(array $options = array())
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Ldap/Ldif/Encoder.php';
    ...
    public function searchSubtree($filter, $scope = Zend_Ldap::SEARCH_SCOPE_SUB, $sort = null)
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Ldap/Node/Collection.php';
    ...
    public function getChildren()
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Ldap/Node/ChildrenIterator.php';
