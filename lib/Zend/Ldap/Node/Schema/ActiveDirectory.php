 ...
 */
require_once LIB_DIR.'/Zend/Ldap/Node/Schema/AttributeType/ActiveDirectory.php';
/**
 * @see Zend_Ldap_Node_Schema_ObjectClass_ActiveDirectory
 */
require_once LIB_DIR.'/Zend/Ldap/Node/Schema/ObjectClass/ActiveDirectory.php';
