 ...
 */
require_once LIB_DIR.'/Zend/View/Helper/Navigation/Helper.php';

/**
 * @see Zend_View_Helper_HtmlElement
 */
require_once LIB_DIR.'/Zend/View/Helper/HtmlElement.php';
    ...
    implements Zend_View_Helper_Navigation_Helper
{
    ...
    public function getContainer()
    {
        if (null === $this->_container) {
            ...
            require_once LIB_DIR.'/Zend/Navigation.php';
