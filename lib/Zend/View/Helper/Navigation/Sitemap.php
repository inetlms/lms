 ...
 */
require_once LIB_DIR.'/Zend/View/Helper/Navigation/HelperAbstract.php';
    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    {
        require_once LIB_DIR.'/Zend/Uri.php';
        ...
        if ($uri->valid()) {
            ...
            require_once LIB_DIR.'/Zend/Uri/Exception.php';
    ...
    public function getDomSitemap(Zend_Navigation_Container $container = null)
    {
        ...
        if ($this->getUseSitemapValidators()) {
            require_once LIB_DIR.'/Zend/Validate/Sitemap/Changefreq.php';
            require_once LIB_DIR.'/Zend/Validate/Sitemap/Lastmod.php';
            require_once LIB_DIR.'/Zend/Validate/Sitemap/Loc.php';
            require_once LIB_DIR.'/Zend/Validate/Sitemap/Priority.php';
        ...
        foreach ($iterator as $page) {
            ...
            if ($this->getUseSitemapValidators() &&
                ...
                require_once LIB_DIR.'/Zend/View/Exception.php';
