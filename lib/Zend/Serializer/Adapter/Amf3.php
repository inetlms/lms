...
require_once LIB_DIR.'/Zend/Serializer/Adapter/AdapterAbstract.php';

/** @see Zend_Amf_Parse_OutputStream */
require_once LIB_DIR.'/Zend/Amf/Parse/OutputStream.php';

/** @see Zend_Amf_Parse_Amf3_Serializer */
require_once LIB_DIR.'/Zend/Amf/Parse/Amf3/Serializer.php';

/** @see Zend_Amf_Parse_InputStream */
require_once LIB_DIR.'/Zend/Amf/Parse/InputStream.php';

/** @see Zend_Amf_Parse_Amf3_Deserializer */
require_once LIB_DIR.'/Zend/Amf/Parse/Amf3/Deserializer.php';
...
class Zend_Serializer_Adapter_Amf3 extends Zend_Serializer_Adapter_AdapterAbstract
{
    ...
    public function serialize($value, array $opts = array())
    {
        try  {
            ...
            require_once LIB_DIR.'/Zend/Serializer/Exception.php';
