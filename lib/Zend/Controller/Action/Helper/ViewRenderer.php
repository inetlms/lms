 ...
 */
require_once LIB_DIR.'/Zend/Controller/Action/Helper/Abstract.php';

/**
 * @see Zend_View
 */
require_once LIB_DIR.'/Zend/View.php';
...
class Zend_Controller_Action_Helper_ViewRenderer extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function getModuleDirectory()
    {
        ...
        if ((null === $moduleDir) || is_array($moduleDir)) {
             ...
             */
            require_once LIB_DIR.'/Zend/Controller/Action/Exception.php';
    ...
    public function getInflector()
    {
        if (null === $this->_inflector) {
             ...
             */
            require_once LIB_DIR.'/Zend/Filter/Inflector.php';
            /**
             * @see Zend_Filter_PregReplace
             */
            require_once LIB_DIR.'/Zend/Filter/PregReplace.php';
            /**
             * @see Zend_Filter_Word_UnderscoreToSeparator
             */
            require_once LIB_DIR.'/Zend/Filter/Word/UnderscoreToSeparator.php';
