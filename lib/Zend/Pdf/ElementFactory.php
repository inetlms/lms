...
require_once LIB_DIR.'/Zend/Pdf/ElementFactory/Interface.php';
...
class Zend_Pdf_ElementFactory implements Zend_Pdf_ElementFactory_Interface
{
    ...
    {
        require_once LIB_DIR.'/Zend/Pdf/ElementFactory/Proxy.php';
    ...
    public function listModifiedObjects($rootFactory = null)
    {
        ...
        $result = array();
        require_once LIB_DIR.'/Zend/Pdf/UpdateInfoContainer.php';
