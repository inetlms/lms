 ...
 */
require_once LIB_DIR.'/Zend/Mail/Storage/Abstract.php';

/**
 * @see Zend_Mail_Protocol_Imap
 */
require_once LIB_DIR.'/Zend/Mail/Protocol/Imap.php';

/**
 * @see Zend_Mail_Storage_Writable_Interface
 */
require_once LIB_DIR.'/Zend/Mail/Storage/Writable/Interface.php';

/**
 * @see Zend_Mail_Storage_Folder_Interface
 */
require_once LIB_DIR.'/Zend/Mail/Storage/Folder/Interface.php';

/**
 * @see Zend_Mail_Storage_Folder
 */
require_once LIB_DIR.'/Zend/Mail/Storage/Folder.php';

/**
 * @see Zend_Mail_Message
 */
require_once LIB_DIR.'/Zend/Mail/Message.php';

/**
 * @see Zend_Mail_Storage
 */
require_once LIB_DIR.'/Zend/Mail/Storage.php';
                             ...
                             implements Zend_Mail_Storage_Folder_Interface, Zend_Mail_Storage_Writable_Interface
{
    ...
    public function countMessages($flags = null)
    {
        if (!$this->_currentFolder) {
             ...
             */
            require_once LIB_DIR.'/Zend/Mail/Storage/Exception.php';
