 ...
 */
require_once LIB_DIR.'/Zend/Markup/TokenList.php';

/**
 * @see Zend_Markup_Parser_ParserInterface
 */
require_once LIB_DIR.'/Zend/Markup/Parser/ParserInterface.php';
...
class Zend_Markup_Parser_Bbcode implements Zend_Markup_Parser_ParserInterface
{
    ...
    public function parse($value)
    {
        if (!is_string($value)) {
             ...
             */
            require_once LIB_DIR.'/Zend/Markup/Parser/Exception.php';
