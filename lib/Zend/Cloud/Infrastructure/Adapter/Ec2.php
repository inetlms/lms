...
require_once LIB_DIR.'/Zend/Service/Amazon/Ec2/Instance.php';
require_once LIB_DIR.'/Zend/Service/Amazon/Ec2/Image.php';
require_once LIB_DIR.'/Zend/Service/Amazon/Ec2/Availabilityzones.php';
require_once LIB_DIR.'/Zend/Service/Amazon/Ec2/CloudWatch.php';
require_once LIB_DIR.'/Zend/Cloud/Infrastructure/Instance.php';
require_once LIB_DIR.'/Zend/Cloud/Infrastructure/InstanceList.php';
require_once LIB_DIR.'/Zend/Cloud/Infrastructure/Image.php';
require_once LIB_DIR.'/Zend/Cloud/Infrastructure/ImageList.php';
require_once LIB_DIR.'/Zend/Cloud/Infrastructure/Adapter/AbstractAdapter.php';
...
class Zend_Cloud_Infrastructure_Adapter_Ec2 extends Zend_Cloud_Infrastructure_Adapter_AbstractAdapter
{
    ...
    public function __construct($options = array())
    {
        ...
        if (empty($options) || !is_array($options)) {
            require_once LIB_DIR.'/Zend/Cloud/Infrastructure/Exception.php';
