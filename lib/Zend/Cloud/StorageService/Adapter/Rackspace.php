...
require_once LIB_DIR.'/Zend/Cloud/StorageService/Adapter.php';
require_once LIB_DIR.'/Zend/Cloud/StorageService/Exception.php';
require_once LIB_DIR.'/Zend/Service/Rackspace/Files.php';
    ...
    implements Zend_Cloud_StorageService_Adapter
{
    ...
    {
        require_once LIB_DIR.'/Zend/Cloud/OperationNotAvailableException.php';
