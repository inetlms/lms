...
require_once LIB_DIR.'/Zend/Service/Amazon/Sqs.php';
require_once LIB_DIR.'/Zend/Cloud/QueueService/Adapter/AbstractAdapter.php';
require_once LIB_DIR.'/Zend/Cloud/QueueService/Exception.php';
