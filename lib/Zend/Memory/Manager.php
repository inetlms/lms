...
require_once LIB_DIR.'/Zend/Memory/Container/Movable.php';

/** Zend_Memory_Container_Locked */
require_once LIB_DIR.'/Zend/Memory/Container/Locked.php';

/** Zend_Memory_AccessController */
require_once LIB_DIR.'/Zend/Memory/AccessController.php';
