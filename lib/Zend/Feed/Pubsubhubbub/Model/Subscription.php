...
require_once LIB_DIR.'/Zend/Feed/Pubsubhubbub/Model/ModelAbstract.php';

/** @see Zend_Feed_Pubsubhubbub_Model_SubscriptionInterface */
require_once LIB_DIR.'/Zend/Feed/Pubsubhubbub/Model/SubscriptionInterface.php';
    ...
    implements Zend_Feed_Pubsubhubbub_Model_SubscriptionInterface
{
    ...
    {
        if (!isset($data['id'])) {
            require_once LIB_DIR.'/Zend/Feed/Pubsubhubbub/Exception.php';
