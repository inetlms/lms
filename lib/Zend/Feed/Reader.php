 ...
 * @see Zend_Feed
 */
require_once LIB_DIR.'/Zend/Feed.php';

/**
 * @see Zend_Feed_Reader_Feed_Rss
 */
require_once LIB_DIR.'/Zend/Feed/Reader/Feed/Rss.php';

/**
 * @see Zend_Feed_Reader_Feed_Atom
 */
require_once LIB_DIR.'/Zend/Feed/Reader/Feed/Atom.php';

/**
 * @see Zend_Feed_Reader_FeedSet
 */
require_once LIB_DIR.'/Zend/Feed/Reader/FeedSet.php';

/** @see Zend_Xml_Security */
require_once LIB_DIR.'/Zend/Xml/Security.php';

/** @see Zend_Xml_Exception */
require_once LIB_DIR.'/Zend/Xml/Exception.php';
