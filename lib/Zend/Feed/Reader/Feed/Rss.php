 ...
 */
require_once LIB_DIR.'/Zend/Feed/Reader/FeedAbstract.php';

/**
 * @see Zend_feed_Reader_Extension_Atom_Feed
 */
require_once LIB_DIR.'/Zend/Feed/Reader/Extension/Atom/Feed.php';

/**
 * @see Zend_Feed_Reader_Extension_DublinCore_Feed
 */
require_once LIB_DIR.'/Zend/Feed/Reader/Extension/DublinCore/Feed.php';
 ...
 */
require_once LIB_DIR.'/Zend/Feed/Reader/Collection/Author.php';
