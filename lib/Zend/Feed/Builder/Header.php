 ...
 */
require_once LIB_DIR.'/Zend/Feed/Builder/Header/Itunes.php';
...
class Zend_Feed_Builder_Header extends ArrayObject
{
    ...
    public function setEmail($email)
    {
        ...
        if (!$validate->isValid($email)) {
             ...
             */
            require_once LIB_DIR.'/Zend/Feed/Builder/Exception.php';
    ...
    public function setTtl($ttl)
    {
         ...
         */
        require_once LIB_DIR.'/Zend/Validate/Int.php';
