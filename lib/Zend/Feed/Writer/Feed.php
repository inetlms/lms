 ...
 */
require_once LIB_DIR.'/Zend/Feed/Writer.php';

/**
 * @see Zend_Feed_Writer_Entry
 */
require_once LIB_DIR.'/Zend/Feed/Writer/Entry.php';

/**
 * @see Zend_Feed_Writer_Deleted
 */
require_once LIB_DIR.'/Zend/Feed/Writer/Deleted.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Atom
 */
require_once LIB_DIR.'/Zend/Feed/Writer/Renderer/Feed/Atom.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Rss
 */
require_once LIB_DIR.'/Zend/Feed/Writer/Renderer/Feed/Rss.php';

require_once LIB_DIR.'/Zend/Feed/Writer/Feed/FeedAbstract.php';
