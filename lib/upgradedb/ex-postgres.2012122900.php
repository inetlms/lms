...
if (!$DB->GetOne("SELECT 1 FROM pg_tables WHERE tablename = ?",array('hv_customers'))) {

$DB->Execute("DROP SEQUENCE IF EXISTS hv_assign_id_seq;");
$DB->Execute("DROP SEQUENCE IF EXISTS hv_billing_id_seq;");
$DB->Execute("DROP INDEX IF EXISTS hv_enduserlist_customerid_idx;");
$DB->Execute("DROP INDEX IF EXISTS hv_pstnusage_number_idx;");
$DB->Execute("DROP INDEX IF EXISTS hv_pstnusage_idrange_idx;");
$DB->Execute("DROP INDEX IF EXISTS hv_pstn_customerid_idx;");
$DB->Execute("DROP INDEX IF EXISTS hv_billing_customerid_idx;");
$DB->Execute("DROP INDEX IF EXISTS hv_billing_success_call_idx;");
$DB->Execute("DROP INDEX IF EXISTS hv_terminal_customerid_idx;");
$DB->Execute("DROP TABLE IF EXISTS hv_enduserlist;");
$DB->Execute("DROP TABLE IF EXISTS hv_terminal;");
$DB->Execute("DROP TABLE IF EXISTS hv_subscriptionlist;");
$DB->Execute("DROP TABLE IF EXISTS hv_pstnusage;");
$DB->Execute("DROP TABLE IF EXISTS hv_pstnrange;");
$DB->Execute("DROP TABLE IF EXISTS hv_pstn;");
$DB->Execute("DROP TABLE IF EXISTS hv_pricelist;");
$DB->Execute("DROP TABLE IF EXISTS hv_customers;");
$DB->Execute("DROP TABLE IF EXISTS hv_pcb;");
$DB->Execute("DROP TABLE IF EXISTS hv_province;");
$DB->Execute("DROP TABLE IF EXISTS hv_county;");
$DB->Execute("DROP TABLE IF EXISTS hv_borough;");
$DB->Execute("DROP TABLE IF EXISTS hv_billing;");
$DB->Execute("DROP TABLE IF EXISTS hv_assign;");
$DB->Execute("DROP TYPE IF EXISTS admin_enum;");
$DB->Execute("DROP TYPE IF EXISTS subscription_used_enum;");
$DB->Execute("DROP TYPE IF EXISTS success_call_enum;");
$DB->Execute("DROP TYPE IF EXISTS screen_numbers_enum;");
$DB->Execute("DROP TYPE IF EXISTS t38_fax_enum;");
$DB->Execute("DROP TYPE IF EXISTS ussage_enum;");
$DB->Execute("DROP TYPE IF EXISTS is_main_enum;");
$DB->Execute("DROP TYPE IF EXISTS disa_enabled_enum;");
$DB->Execute("DROP TYPE IF EXISTS clir_enum;");
$DB->Execute("DROP TYPE IF EXISTS virtual_fax_enum;");
$DB->Execute("DROP TYPE IF EXISTS voicemail_enabled_enum;");
$DB->Execute("DROP TYPE IF EXISTS charge_internal_call_enum;");
$DB->Execute("DROP TYPE IF EXISTS issue_invoice_enum;");
$DB->Execute("DROP TYPE IF EXISTS payment_type_enum;");
$DB->Execute("DROP TYPE IF EXISTS is_wlr_enum;");
$DB->Execute("DROP TYPE IF EXISTS active_enum;");
$DB->Execute("DROP TYPE IF EXISTS consent_data_processing_enum;");
$DB->Execute("DROP TYPE IF EXISTS open_registration_enum;");
$DB->Execute("DROP TYPE IF EXISTS is_removed_enum;");
$DB->Execute("CREATE TYPE admin_enum AS ENUM('t','f');");
$DB->Execute("CREATE TYPE subscription_used_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE success_call_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE screen_numbers_enum AS ENUM('t','f');");
$DB->Execute("CREATE TYPE t38_fax_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE ussage_enum AS ENUM('t','f');");
$DB->Execute("CREATE TYPE is_main_enum AS ENUM('t','f');");
$DB->Execute("CREATE TYPE disa_enabled_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE clir_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE virtual_fax_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE voicemail_enabled_enum AS ENUM('t','f');");
$DB->Execute("CREATE TYPE charge_internal_call_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE issue_invoice_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE payment_type_enum AS ENUM('prepaid','postpaid');");
$DB->Execute("CREATE TYPE is_wlr_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE active_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE consent_data_processing_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE open_registration_enum AS ENUM('f','t');");
$DB->Execute("CREATE TYPE is_removed_enum AS ENUM('f','t');");


$DB->Execute("CREATE SEQUENCE hv_assign_id_seq;");
$DB->Execute("
CREATE TABLE hv_assign (
	...
	PRIMARY KEY(id));
");
$DB->Execute("CREATE INDEX hv_assign_customerid_idx ON hv_assign (customerid);");

$DB->Execute("CREATE SEQUENCE hv_billing_id_seq;");
$DB->Execute("
CREATE TABLE hv_billing (
	...
	PRIMARY KEY (id));
");
$DB->Execute("CREATE INDEX hv_billing_customerid_idx ON hv_billing (customerid);");
$DB->Execute("CREATE INDEX hv_billing_success_call_idx ON hv_billing (success_call);");
...
CREATE TABLE hv_pstn (
	...
	PRIMARY KEY(id));
");
$DB->Execute("CREATE INDEX hv_pstn_customerid_idx ON hv_pstn (customerid);");
...
");
$DB->Execute("CREATE INDEX hv_pstnusage_number_idx ON hv_pstnusage (number);");
$DB->Execute("CREATE INDEX hv_pstnusage_idrange_idx ON hv_pstnusage (idrange);");
...
CREATE TABLE hv_terminal (
	...
	PRIMARY KEY (id));
");
$DB->Execute("CREATE INDEX hv_terminal_customerid_idx ON hv_terminal (customerid);");
...
CREATE TABLE hv_enduserlist (
	...
	PRIMARY KEY (id));
");
$DB->Execute("CREATE INDEX hv_enduserlist_customerid_idx ON hv_enduserlist (customerid);");
